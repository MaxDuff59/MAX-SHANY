...
# Autorise localhost + réseau local (téléphone en WiFi) en dev, et les déploiements Vercel en prod.
app.add_middleware(
    CORSMiddleware,
    allow_origins=[frontend_origin, "http://localhost:5173", "http://127.0.0.1:5173"],
    allow_origin_regex=r"(http://(localhost|127\.0\.0\.1|192\.168\.\d{1,3}\.\d{1,3}|10\.\d{1,3}\.\d{1,3}\.\d{1,3})(:\d+)?|https://max-shany[a-z0-9-]*\.vercel\.app)",
